...
const sections: StepSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '수고비', desc: '왕복 거리에 따라 자동 계산되는 운전자 사례비입니다. 탑승자 인원으로 나눕니다.' },
      { label: '탑승자', desc: '이 차량에 탑승한 참가자를 선택합니다. (운전자 제외)' },
    ],
    note: '유류비 = (거리×단가 + 톨비 + 주차비) ÷ (운전자+탑승자 수)\n수고비 = 거리 기준 자동 계산 금액 ÷ 탑승자 수',
  },
  {
    step: '4',
    title: '🚐 렌트 탭 — 렌트 비용 정산',
    ...
    items: [
      ...
      { label: '왕복 거리 (km)', desc: '총 주행 거리. 거리 기준 수고비 자동 계산에 사용됩니다.' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '분담자 선택', desc: '이 경비를 함께 부담할 참가자를 선택합니다. 모두 해제하면 해당 경비는 정산에서 제외됩니다.' },
    ],
  },
  {
    step: '6',
  ...
  },
  {
    ...
    title: '🧮 정산 규칙 및 주의사항',
    items: [
      { label: '차량 입력 순서', desc: '정산 오류를 막기 위해 차량 비용이나 탑승자를 입력하기 전에 운전자를 먼저 선택하세요.' },
      { label: '여러 대 카풀', desc: '차량별 비용을 먼저 계산한 뒤, 전체 카풀 차량의 운전자·탑승자를 기준으로 합산 정산합니다. 차량별로 따로 N빵하지 않습니다.' },
      { label: '수고비 기준', desc: '왕복 거리 50km 단위로 3,000원씩 자동 계산됩니다. 예: 1~50km는 3,000원, 51~100km는 6,000원입니다.' },
      { label: '렌트 운전자 여러 명', desc: '렌트비 환급은 운전자에게 균등 분배되고, 수고비만 운전 거리 비율(미입력 시 균등)에 따라 분배됩니다.' },
      { label: '카풀 해제', desc: '카풀을 해제한 참가자는 카풀 차량의 운전자·탑승자로 선택할 수 없고, 카풀 유류비·수고비 정산에서도 제외됩니다.' },
      { label: '경비 분담자', desc: '새 참가자를 추가하면 기존 경비 항목의 분담자에도 자동 포함됩니다. 필요하면 경비 탭에서 조정하세요.' },
      { label: '참고 정보', desc: '지도 URL과 메모는 참고·공유용이며 정산 금액에는 영향을 주지 않습니다.' },
      { label: 'JSON 복원', desc: '불러오기는 현재 입력 내용을 대체합니다. 필요하면 먼저 JSON 백업을 받아 두세요.' },
    ],
  },
];
