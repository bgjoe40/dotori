  ...
  return (
    ...
    >
      <div className="w-full max-w-xl rounded-2xl bg-white shadow-xl">
        {/* 헤더 */}
        <div className="flex items-center justify-between rounded-t-2xl border-b border-stone-100 bg-white px-5 py-3">
        ...
        {/* 푸터 */}
        <div className="rounded-b-2xl border-t border-stone-100 px-5 py-2.5">
